...
name `wdf`. Operations such as the following becom possible::

    my_series.wdf.to_freq('1h', method='volume_conservative')
    a_power_series.wdf.to_energy()
...
name `wdf`. Operations such as the following becom possible::
    ...
    power_data.wdf.power_to_freq('1h')
    power_data.wdf.power_to_energy()
...
@pd.api.extensions.register_series_accessor("wdf")
...
@pd.api.extensions.register_dataframe_accessor("wdf")
