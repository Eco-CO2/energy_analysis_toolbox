...
name `et`. Operations such as the following becom possible::

    my_series.et.to_freq('1h', method='volume_conservative')
    a_power_series.et.to_energy()
...
name `et`. Operations such as the following becom possible::
    ...
    power_data.et.power_to_freq('1h')
    power_data.et.power_to_energy()
