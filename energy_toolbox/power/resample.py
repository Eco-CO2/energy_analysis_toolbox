...
def to_freq(series: "pd.Series[float]", freq, origin=None, last_step_duration=None) -> "pd.Series[float]":
    ...
    .. seealso::
        ...
        * :py:func:`energy_toolbox.timeseries.resample.conservative.flow_rate_to_freq`
        * :py:func:`energy_toolbox.timeseries.resample.conservative.flow_rate_conservative`
