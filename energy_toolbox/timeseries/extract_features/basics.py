...
def timestep_durations(timeseries, last_step=None):
    ...
    .. seealso::
        ...
        :py:func:`energy_toolbox.timeseries.extract_features.basics.index_to_timesteps`
...
def index_to_timesteps(time_indexes, last_step=None):
    ...
    .. seealso::
        ...
        :py:func:`energy_toolbox.timeseries.extract_features.basics.timestep_durations`
