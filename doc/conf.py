...
`here <https://www.sphinx-doc.org/en/master/usage/configuration.html>`_.
"""

import energy_analysis_toolbox

project = "energy_analysis_toolbox"
copyright = "2024, energy_analysis_toolbox developers"  # noqa:A001
...
.. |flow_rate_conservative| replace:: :py:func:`flow_rate_conservative
   <cenergy_analysis_toolbox.timeseries.power.conservative.flow_rate_conservative`
.. |volume_conservative| replace:: :py:func:`volume_conservative
   <energy_analysis_toolbox.timeseries.power.conservative.volume_conservative`

.. |EATK.start_f| replace:: :py:const:`EATK.start_f
   <energy_analysis_toolbox.keywords.start_f>`
.. |EATK.end_f| replace:: :py:const:`EATK.end_
   <energy_analysis_toolbox.keywords.end_f>`
.. |EATK.time_f| replace:: :py:const:`EATK.time_f
   <energy_analysis_toolbox.keywords.time_f>`
