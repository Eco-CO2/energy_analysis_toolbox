...
==================================
.. automodule:: energy_toolbox.timeseries
   :members:
   :undoc-members:
   :show-inheritance:
   :private-members:
...
- :py:mod:`energy_toolbox.timeseries.create` contains functions to create
  timeseries data in left-closed right-open sampling from other kinds of
  representations of time-dependent data.
- :py:mod:`energy_toolbox.timeseries.extract_features` contains functions
  ...
  etc.
- :py:mod:`energy_toolbox.timeseries.math` contains functions to perform
  mathematical operations on timeseries data, such as computing the derivative
  of a timeseries.
- :py:mod:`energy_toolbox.timeseries.resample` contains functions to resample
...
- :py:mod:`energy_toolbox.timeseries.profiles` contains functionalites to
...
.. toctree::
   ...
   energy_toolbox.timeseries.create
   energy_toolbox.timeseries.extract_features
   energy_toolbox.timeseries.math
   energy_toolbox.timeseries.resample
   energy_toolbox.timeseries.profiles
